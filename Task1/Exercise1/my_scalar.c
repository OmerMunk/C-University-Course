...
/* 
	...
	The program my_scalar, print some informative instructions for the user and/or for the input file,
	and calculates the scalar product of two vectors, using an algebric method.
	The function calculates, according to the input, the scalar product of two vectors.
	assuming that the values of the two vectors are integers and the size
...
/* 
	This main function is an informative function that call to the input instructions function, 
...
int main(){
	printf("\nStarting execution for my_scalar.c\n");
